...
def transfer_learning(args, results_path: Path):
    ...
    for dataset_name in args.benchmark:
        ...
        # FIX: Handle missing building_type attribute
        try:
            building_type = dataset_generator.building_type
        except AttributeError:
            # Default to residential if building_type is not available
            print(f"Warning: building_type not found for dataset {dataset_name}, defaulting to residential")
